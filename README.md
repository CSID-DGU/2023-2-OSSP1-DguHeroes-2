...
```
✔️ 위의 과정을 통해 구한 이번 프로젝트에서 얻은 데이터의 표준편차의 합은 543.9959이고, 최초 프로젝트에서 얻은 데이터의 표준편차의 합은 567.9385이다. <span style='background-color: #fff5bl'>(표준편차의 평균은 각각 10.87992, 11.35877)</span>
