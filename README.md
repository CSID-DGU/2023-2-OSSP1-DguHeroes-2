...
3. 추천 알고리즘 바탕으로 팀 매칭하기<br>
  1) 전 프로젝트의 알고리즘 기준 팀원 10명을 정렬하고 최대 유사도를 갖는 유저를 역할 별로 한명씩 찾는다.<br>
  2) 본 프로젝트의 알고리즘 기준 팀원 10명을 정렬하고 최대 유사도를 갖는 유저를 역할 별로 한명씩 찾는다.<br>
4. GitHub Stats로 표준편차 구하기<br>
  1) 전 프로젝트 알고리즘에서 선정된 역할 별 1위 유저들에 대해서 GitHub Stats를 구한 뒤, GitHub Stats에 대해서 표준편차를 구한다.<br>
  2) 본 프로젝트 알고리즘에서 선정된 역할 별 1위 유저들에 대해서 GitHub Stats를 구한 뒤, GitHub Stats에 대해서 표준편차를 구한다.<br>
